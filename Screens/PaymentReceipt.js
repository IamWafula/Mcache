...
const PaymentReceipt = ({navigation, route}) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{alignItems: "center", justifyContent:"center"}}>
                <Text style={{color:"#868686", fontSize: 20, fontWeight: "bold", textAlign:"center", marginBottom: 10}}>{data.bank}</Text>
                <View style={{flexDirection:"row", justifyContent: "space-between", borderBottomWidth: 2, borderBottomColor:"lightgray", paddingBottom: 10}}>
                    ...
                    <View style={{alignItems:"flex-start"}}>
                        ...
                        <Text style={{fontSize: 16, fontWeight: "bold", color:"#ff6600"}}>{data.category}</Text>
                ...
                <View style={{paddingTop: 20}}>
                    <View style={{flexDirection: "row", alignItems:"center", justifyContent: "space-evenly", marginBottom:10}}>
                        ...
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#868686"}} > Account No. : </Text>
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#6400ff"}}>{data.accountNumber}</Text>
                    </View>
                    <View style={{flexDirection: "row", alignItems:"center", justifyContent: "space-evenly", marginBottom:10}}>
                        <FontAwesome5 name="book-reader" size={24} color="#868686" />
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#868686"}} > Student ID : </Text>
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#6400ff"}}>{data.studentId}</Text>
                    </View>
                    <View style={{flexDirection: "row", alignItems:"center", justifyContent: "space-evenly", marginBottom:10}}>
                        <FontAwesome name="institution" size={24} color="#868686" />
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#868686"}} > Institution : </Text>
                        <Text style={{fontSize:18, fontWeight:"bold", color:"#6400ff"}}>{data.institution}</Text>
                    </View>
                    <View style={{flexDirection: "row", alignItems:"center", justifyContent: "space-evenly", marginBottom:10}}>
